...
function two() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 2 Cryptic Hunt" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>I see you...</h1>
