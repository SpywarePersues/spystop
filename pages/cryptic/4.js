...
function four() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 4 Cryptic Hunt" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>https://youtu.be/DPMluEVUqS0</h1>
