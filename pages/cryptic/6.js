...
function six() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 6 Cryptic Hunt" />
            <img src="../../wave-bg.png" alt="wave" className="fixed top-0 -z-10 h-screen"/>
            <ToastContainer />
            <h1 className='font-Bungee text-5xl text-white text-center mb-6'>Level 6</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>Never gonna give you up</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>Never gonna let you down</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>Never gonna run around and desert you</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>Never gonna make you cry</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>Never gonna say goodbye</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-5 mb-10'>Never gonna tell a lie and hurt you</h1>
            ...
            <button className="font-Bebas text-center button mt-2 bg-gradient-to-r from-blue-500 to-pink-600 px-5 text-gray-200 w-fit py-2 rounded-md text-xl mx-auto block" onClick={async () => {
                                if(answer === "wheneveryouneedsomebody"){
