...
function nine() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 9 Cryptic Hunt" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-5'>shape of you</h1>
