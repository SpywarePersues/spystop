...
function index() {
    ...
    return (
        <div>
            <Navbar title="Cryptic Hunt" />
            <img src="./wave-bg.png" alt="wave" className="fixed top-0 -z-10 h-screen"/>
            <h1 className='font-Bebas text-5xl text-center md:text-right text-white mx-12'>Current Level : {userCrypticLevel}</h1>
