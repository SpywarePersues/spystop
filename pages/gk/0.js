...
function zero() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 0 General Knowledge" />
            <img src="../../wave-bg.png" alt="wave" className="fixed top-0 -z-10 h-screen"/>
            <h1 className='font-Bungee text-5xl text-white text-center mb-6'>Level 0</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Full form of UPSC</h1>
            <div className='md:flex w-10/12 md:w-6/12 mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) United Public Service Commission</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Union Public Service Commission.</h1>
            </div>
            <div className='md:flex w-10/12 md:w-6/12 mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) United Personal Service Commission</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Union Picture Service Commission.</h1>
            </div>
