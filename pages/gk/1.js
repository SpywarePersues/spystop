...
function one() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 1 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>first olympic games were held in</h1>
            <div className='md:flex w-10/12 md:w-3/12 mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) 6 April 1897</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) 16 April 1894</h1>
            </div>
            <div className='md:flex w-10/12 md:w-3/12 mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) 11 April 1896</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) 6 April 1896</h1>
            </div>
