...
function two() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 2 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>name of the first satellite launched</h1>
            <div className='md:flex w-10/12 md:w-3/12 mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Sputnik 1</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Aryabhatta</h1>
            </div>
            <div className='md:flex w-10/12 md:w-3/12 mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Explorer 1</h1>
