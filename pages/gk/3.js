...
function three() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 3 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>name of the first computer</h1>
            <div className='md:flex w-10/12 md:w-[21%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) ENAIC</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) ENIAC</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[21%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) ENICA</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) EINAC</h1>
            </div>
