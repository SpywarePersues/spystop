...
function five() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 5 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>full name of ak47 rifle</h1>
            <div className='md:flex w-10/12 md:w-[39%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Avtomat Kalashnikovoa 1947</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Avtomat Kalashniova 1947</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[39%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Avtomat Kalasnikova 1947</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Avtomat Kalashnikova 1947</h1>
            </div>
