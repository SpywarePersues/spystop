...
function six() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 6 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Full form of NATO</h1>
            <div className='md:flex w-10/12 md:w-[45%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) North American Treaty Organization</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) North Atlantic Treaty Organization</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[45%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) North African Treaty Organization</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) North Altantic Treaty Organization</h1>
            </div>
