...
function seven() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 7 General Knowledge" />
            <img src="../../wave-bg.png" alt="wave" className="fixed top-0 -z-10 h-screen"/>
            <ToastContainer />
            <h1 className='font-Bungee text-5xl text-white text-center mb-6'>Level 7</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>All Members of BRICS</h1>
            <div className='md:flex w-10/12 md:w-[50%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Brazil, Romania, China, South Africa, India</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Brazil, Russia, China, South Korea, India</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[48%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Brazil, Russia, China, South Africa, India</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Brazil, Romania, China, Sweden, India</h1>
            </div>
