...
function eight() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 8 General Knowledge" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>3rd president of usa</h1>
            <div className='md:flex w-10/12 md:w-[29%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Thomas Jefferson</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) John Adams</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[29%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Martin Van Buren</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Chester A. Arthur</h1>
            </div>
