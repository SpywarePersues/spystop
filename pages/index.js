...
export default function Home() {
  return (
    <div className="text-gray-900 w-screen h-screen overflow-x-hidden">
      ...
      <p className="text-white">Welcome to <span className="underline text-green-700">SpyStop</span>, play awesome games built almost half a decade ago, and get rewarded with our new <span className="underline text-purple-500">digital coins</span>. Redeem your coins and get <span className="underline text-yellow-500">Premium stuffs</span> for different games.
      But wait, There is a slight problem, cannot make <span className="underline text-red-500">friends</span> in online web games? well we got it covered for you!.</p>
