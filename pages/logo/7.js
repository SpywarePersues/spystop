...
function seven() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 7 Guess the correct Logo" />
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>AirBNB Logo</h1>
            <img src='https://cdn.discordapp.com/attachments/910730837996224584/1043854319834910800/unknown.png' className='w-10/12 md:w-4/12 mx-auto rounded-lg hover:scale-105 transition-all duration-200 my-6' />
