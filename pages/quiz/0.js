...
function zero() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Who created C++</h1>
            <div className='md:flex w-10/12 md:w-4/12 mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Bjarne Stroustrip</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Bjanen Stroustrup</h1>
            </div>
            <div className='md:flex w-10/12 md:w-4/12 mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Bjarne Stroustrup</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Bnajre Stroustrup</h1>
            </div>
