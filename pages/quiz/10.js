...
function nine() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Who is H̴kon Wium Lie?</h1>
            <div className='md:flex w-10/12 md:w-[31%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Creator of HTML</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Creator of CSS</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[35%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Creator of Javascript</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Creator of Python</h1>
            </div>
