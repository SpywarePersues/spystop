...
function two() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Who created Laravel</h1>
            <div className='md:flex w-10/12 md:w-[27%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Taylor Otwell</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Taylor Otwwel</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[27%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Tayler Otwell</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Tayler Otweel</h1>
            </div>
