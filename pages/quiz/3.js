...
function three() {
    ...
    return (
        <div>
            <Navbar title="Lvl - 3 Tech Quiz" />
            <img src="../../wave-bg.png" alt="wave" className="fixed top-0 -z-10 h-screen"/>
            <ToastContainer />
            <h1 className='font-Bungee text-5xl text-white text-center mb-6'>Level 3</h1>
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Most Popular Language</h1>
            <div className='md:flex w-10/12 md:w-[22%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Python</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Javascript</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[18%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Java</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) C++</h1>
            </div>
