...
function four() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>most popular framework of javascript</h1>
            <div className='md:flex w-10/12 md:w-[22%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) AngularJS</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) VueJS</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[20%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) NextJS</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) ReactJS</h1>
            </div>
