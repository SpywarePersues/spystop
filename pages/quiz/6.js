...
function six() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>What language is hardest to code</h1>
            <div className='md:flex w-10/12 md:w-[22%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Python</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Laravel</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[22%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Haskell</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Ruby</h1>
            </div>
