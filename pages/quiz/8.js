...
function seven() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Who created me?</h1>
            <div className='md:flex w-10/12 md:w-[27%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Supriyo Kosh</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Supriyo Ghosh</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[27%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Supriyo Josh</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Supriyo Rosh</h1>
            </div>
