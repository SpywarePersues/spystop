...
function nine() {
    ...
    return (
        <div>
            ...
            <h1 className='font-Bebas text-5xl text-white text-center my-10'>Who is Urban Müller?</h1>
            <div className='md:flex w-10/12 md:w-[45%] mx-auto'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>1) Creator of BrainF*ck Programming Language</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>2) Creator of Javascript</h1>
            </div>
            <div className='md:flex w-10/12 md:w-[35%] mx-auto mb-10'>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>3) Creator of Haskell</h1>
                <h1 className='text-white text-xl my-4 mx-10 font-Bebas'>4) Creator of NextJS</h1>
            </div>
